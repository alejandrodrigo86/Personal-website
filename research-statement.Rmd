...
knitr::include_graphics("Files/CONACyT Grants/Masters.pdf")
```
...
```{r, echo=FALSE, out.width='100%', out.height='1000px' }
knitr::include_graphics("Files/CONACyT Grants/Mix_PhD.pdf")
```
